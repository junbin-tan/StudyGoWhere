...
const ContentCard = ({ className, bgClasses = "bg-lightgray-80", style, onClick, children }) => {
  return (
    <div className={`card border border-solid border-gray-300 px-5 py-8 rounded-lg shadow-lg 
    ${className} + " " + ${bgClasses}`}
