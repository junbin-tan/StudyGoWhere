...
const ContentCard_PadM = ({ className, bgClasses = "bg-lightgray-80", onClick, children, ...rest}) => {
  return (
    <div className={`card border border-solid border-gray-300 px-4 py-4 rounded-lg shadow-lg 
    ${className} + " " + ${bgClasses}`}
        {...rest}>
      {children}
    </div>
...
export default ContentCard_PadM;
